...
const BALLERINA_INSTALLATION_PATH_MAC = "/Library/Ballerina/ballerina-1.0.3"
const BALLERINA_INSTALLATION_PATH_UBUNTU = "/usr/lib/ballerina/ballerina-1.0.3"
...
const DOCKER_CLI_BALLERINA_EXECUTABLE_PATH = "/usr/lib/ballerina/ballerina-1.0.3/bin/ballerina"
