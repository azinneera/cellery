...
public class CelleryConstants {
    ...
    public static final String BALLERINA_INSTALLATION_PATH_MAC = "/Library/Ballerina/ballerina-1.0.3";
    public static final String BALLERINA_INSTALLATION_PATH_UBUNTU = "/usr/lib/ballerina/ballerina-1.0.3";
